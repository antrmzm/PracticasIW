...
const campos = ["nombre","password","confirmPassword","pregunta","respuesta","correo"];
...
function validarCampo(id){
    ...
    if(!regex.test(input.value)){
        error.textContent = "Debe tener mínimo 5 caracteres, un número y un carácter especial (._-/!#$)";
        input.classList.add("invalido");
        return false;
    }
    }
